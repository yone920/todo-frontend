...
export default function Category({todo, index, addTodo, deleteTodo, deleteCategory, markedOrNot}) {
    ...
    const mapOverTodos = () => {
           return todo.todos.map((singleTodo) => {
                return <Todo singleTodo={singleTodo} key={singleTodo.id}deleteTodo={deleteTodo} markedOrNot={markedOrNot}/>
            }) 
    }
            ...
            <div className="category">
                <div onDoubleClick={handleTodoBox} className="category__header">
                    ...
                    <div className="category__delete" >
                        <svg viewBox="0 0 32 32" className="icon icon-clear" onClick={handleClick} viewBox="0 0 32 32" aria-hidden="true"><path d="M7.004 23.087l7.08-7.081-7.07-7.071L8.929 7.02l7.067 7.069L23.084 7l1.912 1.913-7.089 7.093 7.075 7.077-1.912 1.913-7.074-7.073L8.917 25z"/></svg>
